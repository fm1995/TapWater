...
<body>
	...
	<div id="wrapper">
		...
		<div id="content" class="xgrid">
			<form name="frm" action="/SyProject/sy/saveArea" method="post">
				<input type="hidden" name="areaDisabled" value="0" />
				<div class="x12">
					...
					<div class="form label-inline uniform">
						...
						<div class="field">
							<label for="name">抄表辖区名称</label> <input id="name" name="areaName"
								size="50" type="text" class="medium" onblur="mysubmit()" /><span
						...
						<div class="field">
							...
							<textarea rows="7" cols="50" id="description" name="areaRemark"></textarea>
