...
<title>湖南省自来水公司营销管理信息系统</title> 
	...
	<script type="text/javascript" src="/SyProject/SY/myJs/rd_volume_update.js"></script>
</head> 
...
<div id="wrapper">
	...
	<input id="volumeId" type="hidden" value="${param.id}" />
	<div id="masthead">
		<div>
		...
		<div class="x12">
			...
			<div id="facebox_setVolume" style="display: none">
				...
				<div class="dialogbutton center">
					<a class="btn btn-grey" href="javascript:history.back(-1);" style="width:120px;">是</a>  
				</div>
			</div>
			...
			<div class="form label-inline uniform">
				...
				<div class="buttonrow">
					<button class="btn" onclick="upVolume()">保存</button>  
