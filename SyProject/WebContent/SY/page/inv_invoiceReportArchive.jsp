...
<script type="text/javascript">
		var selPage = function(fh)
		{
			...
			location.href="/SyProject/iv/archiveSelect?page="+page;
		}
</script>
</head> 
	...
	<div id="content" class="xgrid" >
		...
		<div class="x12">
			...
			<table class="report">
				...
				<tbody>
				<c:forEach var="ar" items="${list.selArchive}">
					<tr>
						<td class="center">${ar.id}</td>
						<td class="center">${ar.startNo }</td>
						<td class="center">${ar.endNo}</td>
						<td class="right">${ar.counts}</td>
						<td class="right">${ar.ivUsed }</td>
						<td class="right">${ar.ivInvalid }</td>
						<td class="center"><fmt:formatDate type="date" value="${ar.date }"/></td>
						<td class="center">${ar.sEmpName }</td>
						<td class="center">${ar.jEmpName }</td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
