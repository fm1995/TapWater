...
<div id="wrapper">
	...
	<div id="content" class="xgrid" >
		...
		<div class="x12">
			...
			<div class="height40">
				<button class="btn btn-small btn-icon btn-arrow-right" onclick="smsInterface();"><span></span>发送</button>
				<button class="btn btn-small btn-icon btn-print" onclick="excelTable();"><span></span>导出为Excel文件</button>
			</div>
			<div class="height40">
				群发内容 <input style="width:550px;" id="outContext" value="尊敬的用户{用户姓名}，您好。你户已欠缴水费 {欠费金额} 元，请在三天内至我公司收费大厅结清水费，否则将停止供水。" onblur="chekedText();"/>
				<select style="width:140px;" id="userType" onchange="chekedText()">
					<option value="给所有用户发送">给所有用户发送</option>
					<option selected="selected" value="只给欠费用户发送">只给欠费用户发送</option>
				</select>
				<button class="btn btn-small btn-icon btn-refresh" onclick="newMassContext();"><span></span>重新生成发送内容</button>
			</div>
			<div class="height40">
			...
			<div class="page">
				<a href="javascript:msgMass(1);">第一页</a>
				<a href="javascript:groupPage(0,true)">上一页</a>
				<input class="pageIndex" id="pageNumber" value="1" onclick="groupPage(2,true)"/> / <input class="pageCount" readonly="readonly" id="number" value="98765" />
				<a href="javascript:groupPage(1,true)">下一页</a>
				<a href="javascript:groupPage(3,true)">第未页</a>
			</div>
