...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript" src="/SyProject/SY/myJs/rd_reportMaxValue.js"></script>
</head> 
...
<div id="wrapper">
	...
	<div id="content" class="xgrid" >
		...
		<div class="x12">
			...
			<div class="height24">
				<div style="float:left;width:200px;">共 <span id="count"></span> 次修改最大表码值</div>
			</div>
			<table class="report" id="table">
				...
				<div class="page">
					...
					<input id="page" class="pageIndex" value="1"/> / <input class="pageCount" id="pageCount" readonly="readonly"  />
