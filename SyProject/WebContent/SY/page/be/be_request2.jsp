	...
	<div id="wrapper">
		...
		<div id="content" class="xgrid">
			...
			<div class="x12">
				...
				<h2>
					用户申请 - 办理分户业务 <a style="float: right"
				...
				<div class="tab_container">
					<ul class="tabs">
						...
						<li><a href="#tab2" onclick="tab2click()">原用户</a></li>
						<li><a href="#tab3" onclick="tab3click()">新户详细表</a></li>
					</ul>
					<div class="tab_content_container">
						<div id="tab1" class="tab_content">
							<form action="/SY/beorder/save2" method="post" name="fm">
								<table width="100%">
									<thead>
										<tr>
											<th width="60"></th>
						...
						<div id="tab3" class="tab_content">
							...
							<div id="meters">
							<form action="/SY/beorder/insert2" method="post" name="fm2">
