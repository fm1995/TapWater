	...
	<div id="wrapper">
		...
		<div id="content" class="xgrid">
			...
			<div class="x12">
				...
				<h2>
					用户申请 - 办理银行代扣水费业务 <a style="float: right"
				...
				<div class="tab_container">
					...
					<div class="tab_content_container">
						<div id="tab1" class="tab_content">
							<form action="/SY/beorder/request4" method="post" name="fm">
								<table width="100%">
									<thead>
										<tr>
											<th width="60"></th>
									...
									<tbody>
										<tr>
											...
											<td><input name="userName" /><input type="hidden"
												value="B4" name="orderNo"></td>
											<td>收费方式</td>
											<td><select style="width: 158px;" name="payType">
						...
						<div id="tab2" class="tab_content">
							<div class="form label-inline uniform">
								...
								<div class="field">
									用户姓名<input disabled="disabled" id="oldname"/>
								</div>
								<div class="field">
									用户电话<input disabled="disabled" id="oldphone"/>
								</div>
								<div class="field">
									用户表径<input disabled="disabled" id="oldmeter"/>
								</div>
								<div class="field">
									用户地址<input disabled="disabled" size="50" id="oldaddr"/>
								</div>
