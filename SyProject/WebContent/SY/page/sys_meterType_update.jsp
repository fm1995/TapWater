...
<body>
	...
	<div id="wrapper">
		...
		<div id="content" class="xgrid">
			<form name="frm" action="/SyProject/sy/updateMeter" method="post">
			<input type="hidden" name="metertypeId" value="${syMeter.metertypeId}"/>
			<input type="hidden" name="meterDisabled" value="0"/>
				<div class="x12">
					...
					<div class="form label-inline uniform">
						...
						<div class="field">
							<label for="id">水表型号ID</label> <input id="id" name="metertypeId"
								size="50" type="text" class="medium" disabled="disabled"
								value="${syMeter.metertypeId}" />
						</div>

						<div class="field">
							<label for="name">水表型号</label> <input id="name"
								name="meterTypeName" value="${syMeter.meterTypeName}" size="50" onblur="mysubmit()" type="text" class="medium" /><span id="no" style="display: none; color: red"></span>
						</div>

						<div class="field">
							<label for="name">设置口径</label> <input id="Aperture"
								name="metertypeAperture" size="50" value="${syMeter.metertypeAperture}" onblur="mysubmit()" type="text" class="medium" /><span id="no1" style="display: none; color: red"></span>
						</div>

						<div class="field">
							<label for="name">最大表码</label> <input id="MaxValue"
								name="metertypeMaxValue" size="50" value="${syMeter.metertypeMaxValue}" onblur="mysubmit()" type="text" class="medium" /><span id="no2" style="display: none; color: red"></span>
						</div>

						<div class="field">
							<label for="name">下限设置</label> <input id="MinValue"
								name="metertypeMinValue" size="50" value="${syMeter.metertypeMinValue}" onblur="mysubmit()" type="text" class="medium" /><span id="no3" style="display: inline; color: red">吨</span>
						</div>

						<div class="field">
							<label for="name">周检年限</label> <input id="Life"
								name="metertypeLife" size="50" value="${syMeter.metertypeLife}" onblur="mysubmit()" type="text" class="medium" /> <span id="no4" style="display: inline; color: red">年</span>
						</div>
						...
						<div class="field">
							...
							<textarea rows="7" cols="50" id="Remark"
								name="metertypeRemark">${syMeter.metertypeRemark}</textarea><span id="no5" style="display: none; color: red"></span>
						</div>
