...
public class UsUser {
    ...
    private BeOrderuser orderUser;

    public BeOrderuser getOrderUser() {
		return orderUser;
	}

	public void setOrderUser(BeOrderuser orderUser) {
	...
	public String toString() {
		return "UsUser [userNo=" + userNo + ", userName=" + userName
