...
public class BeOrder {
	...
	public String toString() {
		return "BeOrder [orderNo=" + orderNo + ", orderType=" + orderType
				+ ", stepId=" + stepId + ", createEmp=" + createEmp
				+ ", createDate=" + createDate + ", completeEmp=" + completeEmp
				+ ", completeDate=" + completeDate + ", lasteditEmp="
				+ lasteditEmp + ", lasteditDate=" + lasteditDate
				+ ", userName=" + userName + ", userType=" + userType
				+ ", address=" + address + ", linkMan=" + linkMan + ", phone="
				+ phone + ", useTarget=" + useTarget + ", houseHeight="
				+ houseHeight + ", maxAmount=" + maxAmount + ", meterTypeId="
				+ meterTypeId + ", meterCount=" + meterCount + ", userRemark="
				+ userRemark + ", payType=" + payType + ", bankCompany="
				+ bankCompany + ", bankNum=" + bankNum + ", oldUserNo="
				+ oldUserNo + ", oldUserName=" + oldUserName
				+ ", oldUserPhone=" + oldUserPhone + ", oldUserAddr="
				+ oldUserAddr + ", oldMeter=" + oldMeter + ", auditEmpId="
				+ auditEmpId + ", auditMessage=" + auditMessage
				+ ", projectMoney=" + projectMoney + ", realMoney=" + realMoney
				+ ", payDate=" + payDate + ", projectDate1=" + projectDate1
				+ ", projectDate2=" + projectDate2 + ", areaId=" + areaId
				+ ", abortCause=" + abortCause + ", syMeterType=" + syMeterType
				+ ", auditEmpName=" + auditEmpName + ", syEmp=" + syEmp + "]";
	}
